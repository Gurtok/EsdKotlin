...
class SensorListener constructor(context: Context ,passedDbHelper: DatabaseHelper, serviceManger: ServiceManager ): Thread(), android.hardware.SensorEventListener{
...
// Phone Sensors
  ...
  private fun parseSensors() {
    try {
      mSensorManager = passedContext.getSystemService(Context.SENSOR_SERVICE) as SensorManager
